                ...
                >
                  <div className="date-section-header">
                    <div className="date-info">
                      ...
                      <a 
                        href={`https://clients.mindbodyonline.com/classic/mainclass?studioid=539962&tg=&vt=&lvl=&stype=&view=&trn=0&page=&catid=&prodid=&date=${tab.dateVal}&classid=0&prodGroupId=&sSU=&optForwardingLink=&qParam=&justloggedin=&nLgIn=&pMode=0&loc=${selectedLocation}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="booking-redirect-link"
                      >
                        <span>官方約課</span>
